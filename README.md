...
Бот использует официальное API расписания университета, поддерживает выбор подгруппы, работу с несколькими группами и кэширование при недоступности сервера.
